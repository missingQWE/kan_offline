...
class MultKAN(nn.Module):
    ...
    def fit(self, train_loader,validate_loader,iid_loader, x_elites, y_elites, args, opt="LBFGS", steps=100, log=1, lamb=0., lamb_l1=1., lamb_entropy=2., lamb_coef=0., lamb_coefdiff=0., update_grid=True, grid_update_num=10, loss_fn=None, lr=0.0005,start_grid_update_step=-1, stop_grid_update_step=50, batch=-1,
